...
float dot(const float* a, const float* b, size_t n) {
    ...
    return ((float*)&result_vector)[0] + ((float*)&result_vector)[1] +
           ((float*)&result_vector)[2] + ((float*)&result_vector)[3];
}
...
void matrix_sub(Matrix* matrix, const Matrix* term) {
    const size_t n = matrix->size;
    __m128* x = (__m128*)matrix->elements;
    __m128* y = (__m128*)term->elements;
